...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2016 at 07:58 PM
...
INSERT INTO `faculty_student_request` (`requestId`, `request_dtm`, `facultyId`, `groupId`) VALUES
(3, '2016-03-30 22:20:07', 13, 9),
(4, '2016-03-30 22:44:45', 13, 12),
(5, '2016-03-30 22:57:22', 13, 14);
...
--
ALTER TABLE `group_requests`
  MODIFY `requestId` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
