...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2016 at 09:09 PM
...
--
ALTER TABLE `faculty`
  MODIFY `facultyId` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
...
--
ALTER TABLE `student`
  MODIFY `studentId` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
--
