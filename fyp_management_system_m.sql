...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='batchDeadlinesInfo' AUTO_INCREMENT=6 ;

--
-- Dumping data for table `batch`
--

INSERT INTO `batch` (`batchId`, `batchName`, `configurationType`) VALUES
(2, 'Fall 2017', 'default'),
(4, 'Fall 2016', 'default'),
(5, 'Fall 2015', 'default');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Default Configurations' AUTO_INCREMENT=10 ;
...
(1, 1, 'Orientation Presentation', NULL, 1, NULL, '', 'default', 'close'),
(2, 2, 'Deliverable 01: Project Team List', 'Use "Template-01" to fill in the details of project team members and submit hard copy to Project Coordinator', 1, NULL, '', 'default', 'close'),
(3, 3, 'Deliverable 02: Project Proposal', 'Use "Template-2 " to write down initial proposal and submit hard copy to project coordinator.\r\nDue Date: -- (Before 3:30pm)', 1, NULL, '', 'default', 'close'),
...
(7, 14, 'Open House (Fall 2015)', 'Date for Open House (Fall 2015) has been finalized. All Part-01 project groups are required to participate in Open House on <strong>--</strong>.\r\nAll project groups (including every member of the team) are required to arrive as early as possible and setup their stalls by 9:00AM.\r\nSDP (Part 01) groups are expected to present their report (first 5 chapters), project idea &amp; prototype at Open House.Each group will be provided a table, an LCD monitor, extension board and couple of chairs. You can run a slide show, presentation or prototype on the LCD monitor.You will also need to design posters, brochures (handouts), 1 banner (3x6 foot), and 1 standee (standard size) for your stall.\r\n<strong>IMPORTANT:</strong> This is mandatory activity - Failure to participate will earn you "F" grade.', 1, NULL, NULL, 'default', 'close'),
(8, 20, 'Progress Presentations', 'SDP (Part 1) project progress presentations have been scheduled on <b>--</b>.\r\n\r\nYou will need to make a presentation (<b>use PPT template</b>) about your project progress and show your project report (5 chapters) &amp; prototype to project review committee.  There are no specific presentation slots - you need to be available whenever review committee calls you for presentation.\r\n\r\nIn regards to presentation, you need to use the attached PPT template and following guidelines:\r\n<b>SLIDE #05: </b>Problem: Clearly state the problem that motivated you to work on your project<b>SLIDE #06:</b> Solution: What are you building to solve the problem?<b>SLIDE #08:</b> Requirements:\r\nList down various techniques &amp; tools you used to develop/elicit requirements\r\nPoint out how did you document these requirements – did you create SRS?', 1, NULL, NULL, 'default', 'close'),
...
CREATE TABLE IF NOT EXISTS `external_examiner_group` (
  `examinerId` int(255) NOT NULL,
  `groupId` int(255) NOT NULL
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Faculty Details' AUTO_INCREMENT=13 ;
...
`facultyStudent` int(255) NOT NULL,
  `groupId` int(255) NOT NULL,
  `facultyId` int(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='facultyGroupInfo' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='FYP Student Records' AUTO_INCREMENT=17 ;
...
`TaskId` int(255) NOT NULL,
  ...
  `week` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='deadlineInfo' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='workload_Info' AUTO_INCREMENT=4 ;
