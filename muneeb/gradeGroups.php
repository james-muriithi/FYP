...
$GLOBALS['title']="FYPMS";
$GLOBALS['subtitle']="Registered Group";
					  ...
					  echo  "<td>";
					   while($rows = $resultm->fetch_assoc()) {
							...
							<select name=\"grade\">
								...
								<option class=\"label-danger\" value=\"F\">F</option>
							</select>
							<input name=\"comments\" type=\"textarea\" placeholder=\"Comments\"/>
							<form id=\"JoinGroup\" action=\"RegisteredGroup.php\" method=\"post\">
								<button id=\"Formlink\" href=\"javascript:;\" value=\"".$rows["studentCMS"]."\">Grade Group</button>
								<input type=\"hidden\" name=\"JoinGroup\" value=\"".$rows["studentCMS"]."\"/>
							</form>";
					   }
					   echo "</td>";
				  }
